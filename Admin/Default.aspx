<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EmployeeCRM.Admin.Default" %>
                                ...
                                <div class="card-header no-border">
                                    <div class="card-title text-xs-center">
                                        <div class="p-1">
                                            ...
                                            <p style="color:darkblue; font-size:40px; font-family:'Segoe UI'">Employee CRM</p>
                                        </div>
                                    </div>
                                    <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Login with Employee CRM</span></h6>
                                </div>
                                <div class="card-body collapse in">
                                    <div class="card-block">
                                        <div class="form-horizontal form-simple" novalidate>
                                            ...
                                            <center><h4 ><a href="../Default.aspx" class="card-link">Click here to Go to website</a></h4></center>
                                        </div>
                                    </div>
                                </div>
