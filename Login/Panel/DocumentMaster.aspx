<%@ Page Title="" Language="C#" MasterPageFile="~/Login/Panel/Panel.Master" AutoEventWireup="true" CodeBehind="DocumentMaster.aspx.cs" Inherits="EmployeeCRM.Login.Panel.DocumentMaster" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlClient" AutoPostBack="true" OnSelectedIndexChanged="ddlClient_SelectedIndexChanged" ClientIDMode="Static" data-placeholder="Choose a Client..." CssClass="form-control" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
