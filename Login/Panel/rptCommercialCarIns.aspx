<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptCommercialCarIns.aspx.cs" Inherits="EmployeeCRM.Login.Panel.CommercialCarIns" %>
...
<body style="font-family: 'Segoe UI'; font-size: 10px;">
    <form id="form1" runat="server">
        ...
        <div id="printDiv">
            ...
            <center style="border: 1px solid black; background-color: black; color: white; font-weight: bold;"><h3>PROPOSAL FORM FOR COMMERCIAL VEHICLES PACKAGE POLICY AND LIABILITY ONLY POLICY</h3>
                (Other than Motor Trade Internal Risks Policy)
            </center>
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <table class="table" style="width: 100%;">
                            ...
                            <tr>
                                <td class="td">Rs.
                                    <asp:Label ID="lbl241" runat="server" Text=""></asp:Label></td>
                                <td class="td">Rs.
                                    <asp:Label ID="lbl242" runat="server" Text=""></asp:Label></td>
                                <td class="td">Rs.
                                    <asp:Label ID="lbl243" runat="server" Text=""></asp:Label></td>
                                <td class="td">Rs.
                                    <asp:Label ID="lbl244" runat="server" Text=""></asp:Label></td>
                                <td class="td">Rs.
                                    <asp:Label ID="lbl245" runat="server" Text=""></asp:Label></td>
                                <td class="td">Rs.
                                    <asp:Label ID="lbl246" runat="server" Text=""></asp:Label></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        8.  Gross Vehicle Weight (GVW) Cubic Capacity (CC) :
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        9.  Max. Licensed Carrying capacity ? (No. of passengers)
                            <br />
                            in case of Passenger carrying Vehicles ? :
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        10. Wheather the extension of geographical area to the following Countries required ?
                    <br />
                ...
                <tr>
                    <td>
                        11. Wheather the vehicle is driven by non-conventional Source of power ? :
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        12. Wheather the vehicle is used for the driving tutions. :
                    </td>
                    <td>
                ...
                <tr>
                    <td>14. Whether the commercial vehicle is also used for Private Purpose (excluding use for hire or reward) ?</td>
                    <td>
                ...
                <tr>
                    <td>16. Whether vehicle is designed for use of Blind/Handicapped/Mentally challenged persons andduty endorsed as such by RTA?</td>
                    <td>
                        <asp:Label ID="lblBlind" runat="server" Text=""></asp:Label></td>
                </tr>
                <tr>
                    <td>17. Whether the vehicle is fitted with fibre glass tank?</td>
                    <td>
                        <asp:Label ID="lblFibre" runat="server" Text=""></asp:Label></td>
                </tr>
                <tr>
                    <td>18. Are you Entitled to a No Claim Bonus?<br />
                ...
                <tr>
                    <td>19. Is the vehicle fitted with the any Anti-theft device approved by the AARI?<br />
                ...
                <tr>
                    <td>20. Lability of Third Parties<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The policy provides Third Party Property Damage (TPPD) of Rs. 1 lakh/-
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Two Wheelers) and Rs. 7.5 lakhs (other class of vehicles)
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>21. Do you wish to cover Legal Liability to ?<br />
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>22. Do you wish to include Personal Accident (P.A.) Cover for paid dirvers, cleaners and conductor ?
                    </td>
                    <td>
                        <asp:Label ID="lblPA" runat="server" Text=""></asp:Label></td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If yes, give name and Capital Sum Insured(CSI) opted for. The maximum CSI available per person is Rs. 1 lakhs in the case of Motorised two wheelers and Rs. 2 lakhs for other classes of vehicle.
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td>23. Do you wish to include Personal Accident (P.A.) Cover for unnamed Persons/hirer/pillion riders (two wheelers) ?
                    </td>
                    <td>
                        <asp:Label ID="lblPATwoWheeler" runat="server" Text=""></asp:Label></td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If yes, give number of persons and Capital Sum Insured (CSI) opted. The maximum CSI available per person is Rs. 1 lakhs in the case of Motorised two wheelers and Rs. 2 lakhs for other classes of vehicles.
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                        24. Insured's Declared Value (Please fill up the following table)
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">25. a. Date of Purchase of the vehicle by the proposer : 
                ...
                <tr>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;f. Type of cover Liability :                     
                ...
                <tr>
                    <td colspan="2">
                        <table style="width: 100%;">
                            <tr>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;g. Claim lodged during the preceeding 3 years</td>
                                <td>Year</td>
                                <td>Number</td>
                                <td>Amount(Rs.)</td>
                            </tr>
                ...
                <tr>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;h. Has any insurance company ever : </td>
                ...
                <tr>
                    <td colspan="2">26. Details of Purchase / Hypothecation / Lease</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">27. Details of Driver : a) Age : 
                ...
                <tr>
                    <td>28. Any other relevant information : 
