<%@ Page Title="" Language="C#" MasterPageFile="~/Login/Client/Client.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="EmployeeCRM.Login.Client.ChangePassword" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtNewPassword" TextMode="Password" CssClass="form-control" placeholder="Create New Password" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
