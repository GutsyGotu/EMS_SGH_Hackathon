<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EmployeeCRM.Login.Default" %>
...
<head runat="server">
    ...
    <title>Login Page - Employee CRM</title>
                        ...
                        <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header no-border">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>MEMBER LOGIN</span></h6>
                                </div>
                                <div class="card-body collapse in" style="background-color: antiquewhite;">
                                    <div class="card-block">
                                        <div class="form-horizontal form-simple" novalidate>
                                            ...
                                            <a href="ClientLogin.aspx" class="btn btn-cyan btn-lg btn-block">Client Login</a>
                                        </div>
                                    </div>
                                </div>
