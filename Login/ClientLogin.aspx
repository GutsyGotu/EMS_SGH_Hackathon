<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientLogin.aspx.cs" Inherits="EmployeeCRM.Login.ClientLogin" %>
...
<head runat="server">
    ...
    <title>Client Login Page - Employee CRM</title>
                        ...
                        <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header no-border">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>CLIENT LOGIN</span></h6>

                                </div>
                                <div class="card-body collapse in" style="background-color:bisque;">
                                    <div class="card-block">
                                        <div class="form-horizontal form-simple" novalidate>
                                            ...
                                            <asp:Button ID="btnLogin" CssClass="btn btn-red btn-lg btn-block" OnClick="btnLogin_Click" runat="server" Text="Login" />
                                            <a href="Default.aspx" class="btn btn-cyan btn-lg btn-block">Member Login</a>
                                        </div>
                                    </div>
                                </div>
